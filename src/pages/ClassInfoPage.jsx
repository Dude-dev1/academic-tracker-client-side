...
export default function ClassInfoPage() {
  ...
  const [activeNav, setActiveNav] = useState("Class Info");
  const [copied, setCopied] = useState({ link: false, code: false });
  const { user } = useAuth();

  // Change to true to test admin view
  // Your backend team will replace this with real role check
  const isAdmin = true;
  ...
  const navItems = [
    ...
    { label: "Assignments",   icon: <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M9 11l3 3L22 4"/><path d="M21 12v7a2 2 0 01-2 2H5a2 2 0 01-2-2V5a2 2 0 012-2h11"/></svg> },
    { label: "Announcements", icon: <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M21 15a2 2 0 01-2 2H7l-4 4V5a2 2 0 012-2h14a2 2 0 012 2z"/></svg> },
    ...(isAdmin ? [{ label: "Class Info", icon: <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M17 21v-2a4 4 0 00-4-4H5a4 4 0 00-4 4v2"/><circle cx="9" cy="7" r="4"/><path d="M23 21v-2a4 4 0 00-3-3.87"/><path d="M16 3.13a4 4 0 010 7.75"/></svg> }] : []),
  ];
  ...
  if (!isAdmin) {
    return (
      <div style={styles.noAccess}>
        ...
        <p style={styles.noAccessSub}>This page is only available to course representatives with Admin access.</p>
      </div>
    );
  }
        ...
        <main style={styles.main}>
              ...
              <div style={styles.courseInfo}>
                <div style={styles.courseInfoHeader}>
                  <div>
                    ...
                    <p style={styles.courseCode}>Course Code : <strong>Acc 252</strong></p>
                  </div>
                ...
                <div style={styles.courseDescRow}>
                  ...
                  <span style={styles.courseDescText}>This is an introductory course designed to create awareness of the accounting concepts and principles.</span>
                </div>
              </div>
            </div>
          </div>
          ...
          <div style={styles.card}>
            ...
            <div style={styles.inviteRow}>
              ...
              <button
                style={{ ...styles.copyBtn, background: copied.link ? "#D1FAE5" : "#fff", color: copied.link ? "#065F46" : "#374151" }}
            ...
            {/* Class Code */}
            <p style={{ ...styles.inviteSubLabel, marginTop: "14px" }}>Class Code</p>
            <div style={styles.inviteRow}>
              <span style={{ ...styles.inviteLink, fontWeight: "600", fontSize: "14px", letterSpacing: "1px" }}>{classCode}</span>
              <button
                style={{ ...styles.copyBtn, background: copied.code ? "#D1FAE5" : "#fff", color: copied.code ? "#065F46" : "#374151" }}
...
const styles = {
  ...
  noAccess: { display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", minHeight: "100vh", gap: "12px", background: "#F0F4FF" },
  noAccessTitle: { fontSize: "18px", fontWeight: "600", color: "#374151" },
  noAccessSub: { fontSize: "13px", color: "#9CA3AF", textAlign: "center", maxWidth: "300px" },
  ...
  main: { padding: "24px 28px", flex: 1, maxWidth: "680px", animation: "fadeUp 0.4s ease both" },
  pageHeader: { marginBottom: "24px" },
  classBadge: { display: "inline-flex", alignItems: "center", gap: "6px", background: "#EDE9FE", color: "#7C3AED", padding: "6px 14px", borderRadius: "8px", fontSize: "12px", fontWeight: "500", marginBottom: "12px" },
  pageTitle: { fontFamily: "'Fraunces', serif", fontSize: "22px", fontWeight: "700", color: "#111827", letterSpacing: "-0.5px" },
  card: { background: "#fff", borderRadius: "16px", border: "0.5px solid #E5E7EB", padding: "20px 24px", marginBottom: "16px", boxShadow: "0 1px 4px rgba(0,0,0,0.06)" },
  courseCard: { display: "flex", gap: "16px" },
  courseIcon: { width: "56px", height: "56px", borderRadius: "12px", background: "#EDE9FE", display: "flex", alignItems: "center", justifyContent: "center", flexShrink: 0 },
  courseInfo: { flex: 1 },
  courseInfoHeader: { display: "flex", alignItems: "flex-start", justifyContent: "space-between", gap: "12px", marginBottom: "10px" },
  courseName: { fontSize: "15px", fontWeight: "600", color: "#111827", marginBottom: "4px" },
  courseCode: { fontSize: "12px", color: "#6B7280" },
  courseDescRow: { display: "flex", gap: "8px" },
  courseDescLabel: { fontSize: "12px", color: "#9CA3AF", whiteSpace: "nowrap", marginTop: "1px" },
  courseDescText: { fontSize: "12px", color: "#6B7280", lineHeight: "1.6" },
  editBtn: { display: "flex", alignItems: "center", gap: "5px", padding: "5px 12px", borderRadius: "8px", border: "0.5px solid #D1D5DB", background: "#fff", fontSize: "12px", fontWeight: "500", cursor: "pointer", fontFamily: "'DM Sans', sans-serif", color: "#374151", whiteSpace: "nowrap", flexShrink: 0 },
  cardLabel: { fontSize: "14px", fontWeight: "600", color: "#111827", marginBottom: "16px" },
  inviteSubLabel: { fontSize: "12px", fontWeight: "500", color: "#6B7280", marginBottom: "8px" },
  inviteRow: { display: "flex", alignItems: "center", gap: "8px", marginBottom: "4px" },
  inviteLink: { flex: 1, fontSize: "12px", color: "#6B7280", background: "#F9FAFB", padding: "8px 12px", borderRadius: "8px", border: "0.5px solid #E5E7EB", whiteSpace: "nowrap", overflow: "hidden", textOverflow: "ellipsis" },
  copyBtn: { display: "flex", alignItems: "center", gap: "5px", padding: "7px 14px", borderRadius: "8px", border: "0.5px solid #D1D5DB", fontSize: "12px", fontWeight: "500", cursor: "pointer", fontFamily: "'DM Sans', sans-serif", whiteSpace: "nowrap", flexShrink: 0, transition: "all 0.2s" },
  regenBtn: { display: "flex", alignItems: "center", justifyContent: "center", gap: "6px", width: "100%", padding: "9px", borderRadius: "8px", border: "0.5px solid #D1D5DB", background: "#fff", fontSize: "13px", fontWeight: "500", cursor: "pointer", fontFamily: "'DM Sans', sans-serif", color: "#374151", marginTop: "16px" },
  dangerZone: { background: "#fff", borderRadius: "16px", border: "0.5px solid #FECACA", padding: "20px 24px", boxShadow: "0 1px 4px rgba(0,0,0,0.06)" },
  dangerLabel: { fontSize: "14px", fontWeight: "600", color: "#374151", marginBottom: "14px" },
  archiveBtn: { display: "block", width: "100%", padding: "10px", borderRadius: "8px", border: "0.5px solid #D1D5DB", background: "#F9FAFB", fontSize: "13px", fontWeight: "500", cursor: "pointer", fontFamily: "'DM Sans', sans-serif", color: "#6B7280", marginBottom: "10px" },
  deleteBtn: { display: "block", width: "100%", padding: "10px", borderRadius: "8px", border: "none", background: "#ef4444", fontSize: "13px", fontWeight: "500", cursor: "pointer", fontFamily: "'DM Sans', sans-serif", color: "#fff" },
};