    ...
    <div style={styles.root}>
      ...
      <div style={styles.content}>
        ...
        <main style={styles.main}>
          {activeTab === "Personal" ? <PersonalView firstName={firstName} /> : <ClassView />}
        </main>
...
const styles = {
  ...
  card: { background: "#fff", borderRadius: "16px", padding: "20px", boxShadow: "0 1px 4px rgba(0,0,0,0.06)", marginBottom: "0" },
