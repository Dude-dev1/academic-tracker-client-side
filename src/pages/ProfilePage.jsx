      ...
      <div style={styles.content}>
        ...
        <main style={styles.main}>
          ...
          <div style={styles.profileHero}>
            ...
            <div style={styles.profileHeroInfo}>
              ...
              <div style={styles.profileTags}>
                {[
                  { label: "KNUST", icon: <svg width="11" height="11" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M3 9l9-7 9 7v11a2 2 0 01-2 2H5a2 2 0 01-2-2z"/></svg> },
                  { label: "2023/2024", icon: <svg width="11" height="11" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><rect x="3" y="4" width="18" height="18" rx="2"/><line x1="16" y1="2" x2="16" y2="6"/><line x1="8" y1="2" x2="8" y2="6"/><line x1="3" y1="10" x2="21" y2="10"/></svg> },
                  { label: "Student", icon: <svg width="11" height="11" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M17 21v-2a4 4 0 00-4-4H5a4 4 0 00-4 4v2"/><circle cx="9" cy="7" r="4"/></svg> },
                ].map(({ label, icon }) => (
                  <span key={label} style={styles.profileTag}>{icon}{label}</span>
                ))}
              </div>
            </div>
          ...
          <div style={{ ...styles.card, marginBottom: "16px" }}>
            <p style={styles.cardTitle}>
              <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="#2563EB" strokeWidth="2"><line x1="18" y1="20" x2="18" y2="10"/><line x1="12" y1="20" x2="12" y2="4"/><line x1="6" y1="20" x2="6" y2="14"/></svg>
              Academic Summary
            </p>
          ...
          <div style={{ ...styles.card, marginBottom: "16px" }}>
            <p style={styles.cardTitle}>
              <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="#2563EB" strokeWidth="2"><path d="M4 19.5A2.5 2.5 0 016.5 17H20"/><path d="M6.5 2H20v20H6.5A2.5 2.5 0 014 19.5v-15A2.5 2.5 0 016.5 2z"/></svg>
              Enrolled Courses
            </p>
                ...
                <div key={i} style={{
                  ...
                  <div style={{ flex: 1 }}>
                    ...
                    <div style={styles.progressTrack}>
                      <div style={{ ...styles.progressBar, width: `${c.pct}%`, background: c.color }} />
                    </div>
                  </div>
          ...
          <div style={styles.dangerZone}>
            ...
            <div style={{ ...styles.dangerRow, borderBottom: "none", paddingBottom: 0 }}>
              <div style={styles.dangerInfo}>
                <strong style={{ ...styles.dangerInfoTitle, color: "#ef4444" }}>Delete Account</strong>
                <span style={{ color: "#ef4444" }}>Permanently remove your account and all data</span>
              </div>
...
const styles = {
  ...
  profileHero: { background: "#2563EB", borderRadius: "16px", padding: "28px 32px", marginBottom: "20px", display: "flex", alignItems: "center", gap: "24px" },
  avatarLg: { width: "72px", height: "72px", borderRadius: "50%", background: "#fff", color: "#2563EB", fontSize: "22px", fontWeight: "600", display: "flex", alignItems: "center", justifyContent: "center", flexShrink: 0, border: "3px solid rgba(255,255,255,0.3)" },
  profileHeroInfo: { flex: 1 },
  profileName: { fontSize: "20px", fontWeight: "500", color: "#fff", marginBottom: "4px" },
  profileRole: { fontSize: "12px", color: "rgba(255,255,255,0.75)", marginBottom: "12px" },
  profileTags: { display: "flex", gap: "8px", flexWrap: "wrap" },
  profileTag: { display: "flex", alignItems: "center", gap: "5px", background: "rgba(255,255,255,0.15)", color: "#fff", fontSize: "11px", padding: "4px 10px", borderRadius: "20px" },
  editProfileBtn: { display: "flex", alignItems: "center", gap: "6px", padding: "8px 16px", background: "rgba(255,255,255,0.15)", color: "#fff", border: "0.5px solid rgba(255,255,255,0.3)", borderRadius: "8px", fontSize: "12px", fontWeight: "500", cursor: "pointer", fontFamily: "'DM Sans', sans-serif", whiteSpace: "nowrap", flexShrink: 0 },
  grid2: { display: "grid", gridTemplateColumns: "minmax(0,1fr) minmax(0,1fr)", gap: "16px", marginBottom: "16px" },
  card: { background: "#fff", borderRadius: "16px", border: "0.5px solid #E5E7EB", padding: "20px 24px", boxShadow: "0 1px 4px rgba(0,0,0,0.06)" },
  cardTitle: { fontSize: "13px", fontWeight: "600", color: "#111827", marginBottom: "16px", display: "flex", alignItems: "center", gap: "8px" },
  infoRow: { display: "flex", justifyContent: "space-between", alignItems: "center", padding: "10px 0", borderBottom: "0.5px solid #F3F4F6" },
  infoLabel: { fontSize: "12px", color: "#9CA3AF" },
  infoValue: { fontSize: "12px", fontWeight: "500", color: "#111827", textAlign: "right" },
  statGrid: { display: "grid", gridTemplateColumns: "repeat(3, minmax(0,1fr))", gap: "10px" },
  statItem: { background: "#F9FAFB", borderRadius: "8px", padding: "12px", textAlign: "center" },
  statNum: { fontSize: "20px", fontWeight: "700", marginBottom: "4px" },
  statLabel: { fontSize: "11px", color: "#6B7280", lineHeight: "1.4" },
  coursesGrid: { display: "grid", gridTemplateColumns: "1fr 1fr", gap: "0 24px" },
  courseItem: { display: "flex", alignItems: "center", gap: "10px", padding: "10px 0" },
  courseDot: { width: "8px", height: "8px", borderRadius: "50%", flexShrink: 0 },
  courseName: { fontSize: "12px", fontWeight: "500", color: "#111827" },
  progressTrack: { height: "5px", background: "#F3F4F6", borderRadius: "3px", overflow: "hidden", marginTop: "4px" },
  progressBar: { height: "100%", borderRadius: "3px" },
  coursePct: { fontSize: "11px", color: "#9CA3AF", marginLeft: "8px", flexShrink: 0 },
  ...
  dangerTitle: { fontSize: "13px", fontWeight: "600", color: "#6B7280", marginBottom: "14px" },
  dangerRow: { display: "flex", alignItems: "center", justifyContent: "space-between", padding: "12px 0", borderBottom: "0.5px solid #F3F4F6" },
  dangerInfo: { fontSize: "12px", color: "#6B7280" },
  dangerInfoTitle: { display: "block", fontSize: "13px", color: "#111827", marginBottom: "2px", fontWeight: "600" },
  grayBtn: { padding: "6px 16px", borderRadius: "8px", border: "0.5px solid #D1D5DB", background: "#F9FAFB", fontSize: "12px", fontWeight: "500", cursor: "pointer", fontFamily: "'DM Sans', sans-serif", color: "#6B7280", whiteSpace: "nowrap" },
  redBtn: { padding: "6px 16px", borderRadius: "8px", border: "none", background: "#ef4444", color: "#fff", fontSize: "12px", fontWeight: "500", cursor: "pointer", fontFamily: "'DM Sans', sans-serif", whiteSpace: "nowrap" },
};