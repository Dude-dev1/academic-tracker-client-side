        ...
        <form onSubmit={handleSubmit} style={styles.form}>
          <div style={styles.fieldGroup}>
            ...
            <div style={{
              ...
              boxShadow: fullNameFocused ? "0 0 0 3px rgba(37,99,235,0.12)" : "none",
            }}>
              <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke={fullNameFocused ? "#2563EB" : "#9CA3AF"} strokeWidth="1.8" style={styles.inputIcon}>
          ...
          <div style={styles.fieldGroup}>
            ...
            <div style={{
              ...
              <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke={emailFocused ? "#2563EB" : "#9CA3AF"} strokeWidth="1.8" style={styles.inputIcon}>
          ...
          <div style={styles.fieldGroup}>
            ...
            <div style={{
              ...
              <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke={passwordFocused ? "#2563EB" : "#9CA3AF"} strokeWidth="1.8" style={styles.inputIcon}>
          ...
          <div style={styles.fieldGroup}>
            ...
            <div style={{
              ...
              boxShadow: confirmFocused ? "0 0 0 3px rgba(37,99,235,0.12)" : "none",
            }}>
              <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke={confirmFocused ? "#2563EB" : "#9CA3AF"} strokeWidth="1.8" style={styles.inputIcon}>
                <rect x="5" y="11" width="14" height="10" rx="2"/>
                <path d="M8 11V7a4 4 0 018 0v4"/>
              </svg>
              <input
...
const styles = {
  ...
  dividerText: { fontSize: "12px", color: "#9CA3AF", fontWeight: "500", whiteSpace: "nowrap" },
